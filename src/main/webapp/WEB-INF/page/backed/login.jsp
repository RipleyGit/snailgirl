...
<div class="logintop">
    <span>欢迎使用Snailgirl平台</span>
   <!--
    <ul>
        <li><a href="LogOut">返回首页</a></li>
    </ul>
    -->
</div>
<div class="loginbody">
    <div class="login-container">
        <div class="center">
            <h1>
                ...
                <span class="orange">田螺姑娘</span>
                <span class="white">后台管理系统</span>
            </h1>
           <%-- <h4 class="white">Background Management System</h4>--%>
            <h4 class="white">SnailGirl Background Management System</h4>
        </div>
            ...
            <div id="login-box" class="login-box widget-box no-border visible">
                <div class="widget-body">
                    <div class="widget-main">
                        ...
                        <div class="login_icon"><img src="${sod}/staticfile/back/images/login.png" /></div>

                        <form class="" action="/backed/toLogin" method="post" >
                            <fieldset>
                                ...
                                <div class="clearfix">
                                    ...
                                    <input class="width-35 pull-right btn btn-sm btn-primary" id="login_btn" type="submit" value="登 陆"/>
                                </div>
...
<div class="loginbm">版权所有    <a href="">SOD软件系统有限公司</a> </div><strong></strong>
</body>
</html>
<script>
