...
<head>
    ...
    <link rel="stylesheet" href="${ sod }/staticfile/back/assets/css/ace-rtl.min.css" />
    <link rel="stylesheet" href="${ sod }/staticfile/back/assets/css/ace-skins.min.css" />
    ...
    <script src="${ sod }/staticfile/back/assets/js/ace-elements.min.js"></script>
    <script src="${ sod }/staticfile/back/assets/js/ace.min.js"></script>
    ...
    <div class="navbar-container" id="navbar-container">
        <div class="navbar-header pull-left">
            <a href="#" class="navbar-brand">
                <small>
                    <img src="${sod}/staticfile/back/images/logo.png">
                </small>
            </a><!-- /.brand -->
        </div><!-- /.navbar-header -->
            ...
            <ul class="nav ace-nav">
                <li class="light-blue">
                    <a data-toggle="dropdown" href="#" class="dropdown-toggle">
                        ...
                        <span  class="time"><em id="time"></em></span><span class="user-info"><small>欢迎光临,</small>${userAdmin.adminName}</span>
                ...
                <li class="purple">
                    <a data-toggle="dropdownOrder" class="dropdown-toggle" href="#"><i class="icon-bell-alt"></i><span class="badge badge-important">0</span></a>
                    <ul class="pull-right dropdown-navbar navbar-pink dropdown-menu dropdown-caret dropdown-close" id="info_alert">
                        <li class="dropdown-header"><i class="icon-warning-sign"></i><span class="msgCount">0</span>条通知</li>
        ...
        <div class="sidebar" id="sidebar">
            ...
            <ul class="nav nav-list" id="nav_list">
                ...
                <li><a href="#" class="dropdown-toggle"><i class="icon-desktop"></i><span class="menu-text"> 菜品管理 </span><b class="arrow icon-angle-down"></b></a>
                    <ul class="submenu">
                        <li class="home"><a  href="javascript:void(0)" name="prodList"  title="菜品列表" class="iframeurl"><i class="icon-double-angle-right"></i>菜品列表</a></li>
                    </ul>
                </li>
                <li>
                    ...
                    <ul class="submenu">
                        ...
                        <li class="home"><a href="javascript:void(0)"  name="orderMge" title="订单管理"  class="iframeurl">订单管理</a></li>
                ...
                <li><a href="#" class="dropdown-toggle"><i class="icon-group"></i><span class="menu-text"> 管理员管理 </span><b class="arrow icon-angle-down"></b></a>
                    <ul class="submenu">
                        ...
                        <li class="home"><a href="javascript:void(0)" name="adminList" title="权限管理"  class="iframeurl"><i class="icon-double-angle-right"></i>管理员列表</a></li>
                    </ul>
                </li>
            </ul>
...
<div class="footer_style" id="footerstyle">
    <p class="l_f">版权所有：Sound Of Dream小组所有</p>
    <p class="r_f">地址：浙江省杭州市江干区白杨街道服务外包大楼414  邮编：310000 技术支持：SOD支持</p>
</div>
<!--修改密码样式-->
...
<%--webSocket--%>
<audio id="notice">
    <source src="${ sod }/staticfile/back/mp3/song.mp3" type="audio/mpeg" />
</audio>
    <script>
        $("[data-toggle='dropdownOrder']").click(function(){
            $("#info_alert").toggle();
        });
        $(".newOrder").click(function(){
            console.log( $(".submenu .home:eq(2)") )
            $(".submenu .home:eq(2) a").trigger("click");
            $("#info_alert").hide();
            var count =$(".badge.badge-important");
            count.html("0");
            var msgCount = $(".msgCount");
            msgCount.html("0");
            var orderCount = $(".pull-right.badge.badge-success");
            orderCount.html("0");
        });
        var websocket = null;
        ...
        websocket.onmessage = function (event) {
            ...
            var orderCount = $(".pull-right.badge.badge-success");
                orderCount.html(Number(orderCount.html())+1);
            var infoAlert = $("#info_alert").show();
            setTimeout(function(){
                infoAlert.hide();
            },5000);
